...
Links:
* [Staging model in UC](https://adb-3579475502667581.1.azuredatabricks.net/explore/data/models/staging/mlops_demo/mlops_demo-model)
* [Prod model in UC](https://adb-3579475502667581.1.azuredatabricks.net/explore/data/models/prod/mlops_demo/mlops_demo-model)
. 
